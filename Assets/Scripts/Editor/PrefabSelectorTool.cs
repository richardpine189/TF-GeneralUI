...
public class PrefabSelectorTool : EditorWindow
{
    ...
    [MenuItem("Tools/Prefab Selector Tool")]
    ...
    private void CreatePrefabInScene()
    {
        ...
        if (prefab != null && !string.IsNullOrEmpty(scenePath))
        {
            ...
            // Mover la instancia a la escena seleccionada
            SceneManager.MoveGameObjectToScene(instance, scene);

            // Posicionar el prefab en (0,0,0) en la escena
            instance.transform.position = Vector3.zero;
            
            // Definir Padre de la nueva instancia a "Canvas" para permitir renderizacion
            instance.gameObject.transform.SetParent(GameObject.Find("Canvas").transform);
            
            // Guardar los cambios en la escena
